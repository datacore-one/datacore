...
- Routing tasks to appropriate org files
- Tagging tasks for AI delegation
- Achieving inbox zero

**Key decisions this DIP informs:**
- Classification workflow (ACTION/PROJECT/REFERENCE/etc.)
- AI tag routing (`:AI:research:`, `:AI:content:`, etc.)
- Task property requirements (EFFORT, PRIORITY)

### Quick Reference

| Question | Answer |
|----------|--------|
| Inbox location? | `org/inbox.org` |
| Task destination? | `org/next_actions.org` |
...
| Agent | Purpose |
|-------|---------|
| `gtd-inbox-coordinator` | Batch inbox processing |

### Integration Points

- **DIP-0009** - Inbox processing workflow
- **DIP-0011** - AI task queuing
- **/tomorrow** - Invokes this for inbox processing
...
3. Category (Organization/Project Alpha/Trading/Personal/etc.):
   → User provides: ___
...
[Create note in ~/Data/3-knowledge/pages/[title].md with wiki-link format]
...
✅ Queued for Research Agent
   ...
   - Generate zettel in 3-knowledge/pages/
...
- `~/Data/journal/[today].md` (read morning goals, write evening summary)
...
- `~/Data/journal/[today].md` (write summary)

**MAY CREATE:**
- `~/Data/3-knowledge/pages/[title].md` (reference notes)
...
- Create reference notes in 3-knowledge/pages/
