...
| What DIPs govern this? | DIP-0007 (Module Spec), DIP-0002 (Layers) |

### Agents This Command Invokes

| Agent | Purpose |
|-------|---------|
| `create-module` | Scaffold/convert/audit |
| `module-registrar` | CATALOG registration |
...
/create-module convert ~/Data/1-teamspace/2-projects/datacortex
