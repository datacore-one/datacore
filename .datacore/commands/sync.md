...
### When to Reference DIP-0010

**Always reference when:**
- Syncing with GitHub issues
- Routing external tasks to org-mode
...
- Task routing rules (labels → org tags)

### Quick Reference

| Question | Answer |
|----------|--------|
| Repo sync? | `./sync` shell script |
| Task sync? | DIP-0010 sync engine |
| Conflict log? | `.datacore/state/sync_history.db` |
| What DIPs govern this? | DIP-0010 (External Sync) |

### Agents This Command Invokes

| Agent | Purpose |
|-------|---------|
| (none) | Uses shell scripts |

### Integration Points

- **DIP-0010** - External sync architecture
- **/today** - Auto-pulls on morning briefing
- **/wrap-up** - Auto-pushes on session close
...
teamspace................ [PULLED/UP-TO-DATE/CONFLICT]
projectspace............. [PULLED/UP-TO-DATE/CONFLICT]
...
Pulling external changes...
  GitHub:
    ...
    - datacore-one/teamspace: [N] issues updated
...
Repositories:
  ...
  teamspace................ [CLEAN/DIRTY] [UP-TO-DATE/AHEAD/BEHIND]
  projectspace............. [CLEAN/DIRTY] [UP-TO-DATE/AHEAD/BEHIND]
...
GitHub:
  ...
  - datacore-one/teamspace: [N] changes
...
Repository errors:
  - teamspace: Merge conflict in org/next_actions.org
