...
1. **Preferred**: Call `plur_inject_hybrid` MCP tool with `prompt` = your task description and `scope` = `agent:module-registrar`
...
- [DIP-0001](../dips/DIP-0001-contribution-model.md) - Contribution workflow
...
* TODO Register datacore-campaigns module :AI:module:register:
  Source: 2-projectspace/1-departments/dev/modules/datacore-campaigns
