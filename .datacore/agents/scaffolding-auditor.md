...
1. **Preferred**: Call `datacore.inject` MCP tool with `prompt` = your task description and `scope` = `agent:scaffolding-auditor`
...
- Auditing scaffolding completeness
- Generating missing scaffolding docs
- Validating document categories
- Checking project module requirements

**Key decisions this DIP informs:**
- Required vs recommended scaffolding
- Category definitions (identity, strategy, brand, etc.)
- Document naming conventions (Title Case)
- Frontmatter requirements for scaffolding

### Quick Reference

| Question | Answer |
|----------|--------|
| Scaffolding status file? | `[space]/SCAFFOLDING.space.md` |
| Required categories? | `.datacore/specs/scaffolding-pattern.md` |
| Document naming? | Title Case for scaffolding docs |
| Audit report location? | `[space]/0-inbox/report-*-scaffolding-audit.md` |

### Related DIPs

- [DIP-0003](../dips/DIP-0003-scaffolding-pattern.md) - Full specification
- [DIP-0002](../dips/DIP-0002-layered-context-pattern.md) - Context layering
- [DIP-0007](../dips/DIP-0007-module-specification.md) - Project requirements

### Related Agents

| Agent | Relationship |
|-------|--------------|
| `context-maintainer` | May call for context validation |
| `archiver` | May archive outdated scaffolding |

### Integration Points

- **DIP-0003** - Follows scaffolding pattern specification
- **Multi-source synthesis** - Combines zettel + notes + research
- **Link-following search** - Discovers related content
...
| `0-personal/3-knowledge/pages/` | P1 | Often richest strategic content |
| `0-personal/journal/` | P2 | Contextual insights |
...
- `0-personal/3-knowledge/pages/[Org] Credo.md` - Contains mission, values
...
**Configuration**:
- `.datacore/templates/space/SCAFFOLDING.base.md` - Canonical template for new spaces
- `[space]/3-knowledge/SCAFFOLDING.base.md` - Deployed category definitions
- `[space]/SCAFFOLDING.space.md` - Status tracking

**Source Content**:
- `[space]/3-knowledge/` - Space knowledge base
- `0-personal/3-knowledge/pages/` - Personal strategic docs
- `0-personal/4-outbox/archive/dated/chatgpt-export-*/` - ChatGPT insights
...
```
Start: [[Organization-Core-Purpose]]
  → Follow: [[PartnerOrg-In-Organization]]
