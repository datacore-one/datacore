...
description: |
  [DEPRECATED] Use research-orchestrator instead.
...
user: "Check all the links in the Organization research section and tell me what's relevant and what opportunities they present."
assistant: "I'll launch the research-link-processor agent to analyze those Organization research links, evaluate their relevance to the business focus, and create both a summary and detailed report with opportunities identified."
...
> **DEPRECATED per DIP-0021**: Replaced by `research-synthesizer`.
> Registry entry has `superseded_by: research-synthesizer`. File kept for reference.
...
- Generating inline tags for summaries
- Adding wiki-links to reports
- Following output formatting standards

**Key decisions this DIP informs:**
- Tag format: inline `#tag` at end
...
| Question | Answer |
|----------|--------|
| Where do summaries go? | `~/Data/content/summaries/` |
| Where do reports go? | `~/Data/content/reports/` |
| File naming format? | `YYYY-MM-DD-[topic]-summary.md` |
| When to use this agent? | 3+ links to process |

### Related DIPs

- [DIP-0014](../dips/DIP-0014-tag-taxonomy.md) - Tag format and wiki-links
- [DIP-0009](../dips/DIP-0009-gtd-specification.md) - GTD action items

### Related Agents

| Agent | Relationship |
|-------|--------------|
| `gtd-research-processor` | Similar purpose, single-link focus |
| `gtd-inbox-processor` | May process resulting tasks |

### Integration Points

- **DIP-0014** - Follows tag taxonomy for notes
- **Obsidian** - Creates wiki-linked notes
- **GTD system** - Generates TODO items for inbox
...
5. **Identify connections**:
   - Links to existing notes in ~/Data/3-knowledge/pages/
...
5. **Complete Reference List**:
   ...
   - Suggested file locations in ~/Data/0-personal/3-knowledge/
...
1. [Full citation with link]
   - Tags: #tag1 #tag2
   - Suggested location: 3-knowledge/pages/[filename].md
...
```
Analysis complete! I've processed 24 Organization research links and saved:

📄 Summary: ~/Data/content/summaries/2025-11-02-organization-research-links-summary.md
📊 Detailed Report: ~/Data/content/reports/2025-11-02-organization-research-links-report.md

Key findings:
- Critical priorities identified for data acquisition
- N major competitors identified
- Revenue opportunity identified for model training
