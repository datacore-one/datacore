...
- Tracking project status in org files
- Identifying blockers and dependencies
- Escalating overdue blockers (7+ days)
- Creating follow-up tasks

**Key decisions this DIP informs:**
- Project tasks in next_actions.org
- Blocker escalation timeline (7 days)
...
| Question | Answer |
|----------|--------|
| Where are project tasks? | `0-personal/org/next_actions.org` |
| When to escalate blockers? | After 7 days |
| What tag triggers me? | `:AI:pm:` |
| Who routes tasks to me? | `ai-task-executor` |

### Related DIPs

- [DIP-0009](../dips/DIP-0009-gtd-specification.md) - GTD project tracking
- [DIP-0016](../dips/DIP-0016-agent-registry.md) - Agent coordination

### Related Agents

| Agent | Relationship |
|-------|--------------|
| `ai-task-executor` | Routes :AI:pm: tasks to me |

### Integration Points

- **DIP-0009** - Manages projects in GTD system
- **GitHub Issues** - May sync with external issue trackers
...
**In project notes:**
```
Look for: ~/Data/1-active/[category]/[Project Name].md
Or: ~/Data/3-knowledge/pages/[Project Name].md
...
**Output Location:** `~/Data/1-active/[category]/`

**Filename:** `[Project Name].md`
- Example: `Project Alpha MVP Project.md`
- Example: `Organization Launch Campaign.md`

**Project Note Structure:**
```markdown
---
type: project-note
category: [Organization/Project Alpha/Trading/Personal]
...
{
  "status": "completed",
  "output_path": "~/Data/1-active/project-alpha/Project Alpha MVP Project.md",
  "summary": "Updated Project Alpha MVP project status. 8/15 tasks complete (53%). 2 blockers identified: CTO API spec (12 days) and design review (5 days). Project timeline at risk.",
...
{
  "status": "needs_review",
  "output_path": "~/Data/1-active/organization/Organization Launch Campaign.md",
...
- Project notes: `~/Data/1-active/`
- Journals: `~/Data/journal/`

**Writes To:**
- `~/Data/1-active/[category]/[Project].md`
