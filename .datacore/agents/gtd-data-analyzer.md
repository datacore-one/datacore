...
1. **Preferred**: Call `datacore.inject` MCP tool with `prompt` = your task description and `scope` = `agent:gtd-data-analyzer`
...
- [DIP-0009](../dips/DIP-0009-gtd-specification.md) - GTD workflow and metrics
- [DIP-0016](../dips/DIP-0016-agent-registry.md) - Performance tracking

### Related Agents

| Agent | Relationship |
|-------|--------------|
| `ai-task-executor` | Routes :AI:data: tasks to me |
...
- Category/work area (Organization, Project Alpha, Trading, Personal, GTD)
...
- Journals: `0-personal/journal/YYYY-MM-DD.md`
- Org files: `0-personal/org/next_actions.org`, `inbox.org`, `habits.org`
...
**For Project Metrics:**
- Org files: `0-personal/org/next_actions.org`
- Project notes: `0-personal/1-active/[project]/`
...
- Group by :CATEGORY: property (Organization, Project Alpha, Trading, Personal)
...
- "Organization tasks taking 2x estimated EFFORT → underestimating complexity"
...
**Output Location:** `content/reports/`
...
---
type: data-report
category: [GTD/Trading/Organization/Project Alpha/Personal]
...
{
  "status": "completed",
  "output_path": "content/reports/2025-11-25-gtd-weekly-metrics-report.md",
...
{
  "status": "needs_review",
  "output_path": "content/reports/2025-11-30-trading-november-report.md",
  ...
  "review_questions": [
    "Should burn rate include one-time expenses or exclude?",
    "Use average monthly burn or trailing 3-month average?",
    "Runway calculation: conservative (high burn) or optimistic (avg burn)?"
  ],
  "partial_metrics": {
    "burn_rate_inclusive": "EXAMPLE_VALUE",
    "burn_rate_exclusive": "EXAMPLE_VALUE",
    "runway_months_conservative": "EXAMPLE_VALUE",
    "runway_months_optimistic": "EXAMPLE_VALUE"
  }
}
```
...
```json
{
  ...
  "recommended_actions": [
    ...
    "Create financial tracking file in 0-personal/org/ or 0-personal/1-active/",
...
**Metrics:**
- Time invested by category (Organization, Project Alpha, Trading, Personal)
...
- Org files: `0-personal/org/`
- Project notes: `0-personal/1-active/`

**Writes To:**
- `content/reports/` (data reports)
