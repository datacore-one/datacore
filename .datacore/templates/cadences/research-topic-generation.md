---
cadence: research-topic-generation
...
evidence:
  path: "1-tracks/research/research-topics-{date}.md"
  require: ["^# Research Topics", "^## "]
  min_bytes: 2000
---

## Objective

Generate the next research topics from what the week's results and papers left open, ranked.
...
4. **Write the report**, headed `# Research Topics — YYYY-MM-DD`, with:
   - `## Summary`
   - `## Context: key developments since the previous cycle`
   - `## Ranked topics, each with the question and the test`
