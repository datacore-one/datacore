...
| S25 | Review backlog size | `grep -chE '^\*+ REVIEW ' ~/Data/*/org/*.org` (NS) | trending DOWN — 242 on 2026-08-30 (184 in 0-personal) while the briefing shows only 20, so the queue grows faster than it drains |
